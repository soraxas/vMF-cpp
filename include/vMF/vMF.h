...
namespace vMF
{
    ...
    public:
        ...
        explicit von_mises_fisher(const param_type &param) : von_mises_fisher(param.mu(), param.kappa())
        {
        }
    ...
    std::basic_ostream<CharT> &operator<<(std::basic_ostream<CharT> &os, const von_mises_fisher<Dim, RealType> &vmf)
    {
